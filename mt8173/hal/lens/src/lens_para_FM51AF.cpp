...
const NVRAM_LENS_PARA_STRUCT FM51AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        -1, // i4MidDir;                    // 
        -1, // i4MacDir;                    // 
        40, // i4RatioInf;                  // below 15342054144f tableLength belongs to INF
        70, // i4RatioMac;                  // above 15342054144f tableLength belongs to MAC ; should be larger than i4RatioInf          
