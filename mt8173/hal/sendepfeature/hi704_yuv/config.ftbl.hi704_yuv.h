...
//#if 1
//
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_HI704_YUV_H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_HI704_YUV_H_
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                // because ISP can't support this for lomo effect, also can't support SOLARIZE, SEPIAGREEN
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "720x480",        "1280x720",     "1280x736",   "1920x1080",   "1920x1088", 
            )
        ), 
    )
#endif
