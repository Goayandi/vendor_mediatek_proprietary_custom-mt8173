...
//#if 1
//
#ifndef _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_OV2724_MIPI_RAW_H_
#define _MTK_CUSTOM_PROJECT_HAL_IMGSENSOR_OV2724_MIPI_RAW_H_
/*******************************************************************************
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_OV2724_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
#endif
    //==========================================================================
// If Use Dynamic Feature Table, then open it     
#if 0
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_PICTURE_SIZE_SCENE(
            ...
            ITEM_AS_EXTRA_VALUES_(
						//"320x240",	"640x480", "1024x768",  "1280x768",  "1280x720", "1600x1200", "1840x1104", "1920x1088"
						//"800x800"
            )
            //ITEM_AS_VALUES_(
			//			"320x240",	"640x480", "1024x768",  "1280x768",  "1280x720", "1600x1200", "1840x1104", "1920x1088"
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "800x800",      "960x540",      "1280x720",     "1280x736",     "1280x768", 
                "1280x960",    "1600x1200",    "1920x1080",    "1920x1088"
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "864x480",      "800x800",      "1280x720",     "1280x736",   "1280x960",  
                "1920x1080",   "1920x1088"
            )
        ), 
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
           ...
           //     MtkCameraParameters::CAPTURE_MODE_EV_BRACKET_SHOT, 
                ...
                //MtkCameraParameters::CAPTURE_MODE_IMAGEREWIND_SHOT,	// only support in Jungle project
            )
        ), 
    )
#endif
...
//                ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE), 
        ...
        FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
            ...
            SCENE_AS_DEFAULT_SCENE(
//                ITEM_AS_DEFAULT_(MtkCameraParameters::OFF), 
                ITEM_AS_DEFAULT_(MtkCameraParameters::KEY_MFB_MODE_MFLL), 
                ITEM_AS_VALUES_(
                    MtkCameraParameters::OFF, 
