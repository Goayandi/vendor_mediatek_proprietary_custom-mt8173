...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            6760000, -750000, -900000, -360000, 6890000, -1400000, 200000, -1690000, 6600000
        },
        {  // i4P10[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Warm fluorescent
                {
                    -246,    // PWFluoRightBound
                    -446,    // PWFluoLeftBound
                    -419,    // PWFluoUpperBound
                    -621    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -246,    // PIncaRightBound
