...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            10430000, -5040000, -280000, -1930000, 8880000, -1830000, -270000, -3280000, 8690000
        },
        {  // i4P10[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    // AWB NVRAM
    {
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    312,    // PCloudyRightBound
                    137,    // PCloudyLeftBound
                    -287,    // PCloudyUpperBound
                    -361    // PCloudyLowerBound
                },
                // Shade
                {
                    412,    // PShadeRightBound
                    137,    // PShadeLeftBound
                    -287,    // PShadeUpperBound
        ...
        // Algorithm Tuning Paramter
        {
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, 
                    {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}
                }, // TUNGSTEN
                {
                    {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, 
                    {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}, {512, 502, 512}
                ...
                {
                    {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, 
                    {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}
                }, // DAYLIGHT
                {
                    {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, 
                    {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}, {518, 502, 512}
                ...
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {492, 512, 512}, {492, 512, 512}, {492, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                } // DAYLIGHT F
            },
